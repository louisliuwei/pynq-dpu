...
source [file join [file dirname [file dirname [info script]]] gui/dpu_eu_v3_0.gtcl]
...
proc update_PARAM_VALUE.DWCV_DSP_NUM { PARAM_VALUE.DWCV_DSP_NUM PARAM_VALUE.ARCH_PP PARAM_VALUE.ARCH_ICP PARAM_VALUE.DWCV_ENA } {
	...
	set values(ARCH_ICP) [get_property value $ARCH_ICP]
	set values(DWCV_ENA) [get_property value $DWCV_ENA]
	set_property value [gen_USERPARAMETER_DWCV_DSP_NUM_VALUE $values(ARCH_PP) $values(ARCH_ICP) $values(DWCV_ENA)] $DWCV_DSP_NUM
}
...
proc update_PARAM_VALUE.UBANK_WGT_N_USER { PARAM_VALUE.UBANK_WGT_N_USER PARAM_VALUE.URAM_N_USER PARAM_VALUE.ARCH_ICP PARAM_VALUE.ARCH_OCP } {
	...
	set values(ARCH_ICP) [get_property value $ARCH_ICP]
	set values(ARCH_OCP) [get_property value $ARCH_OCP]
	set_property value [gen_USERPARAMETER_UBANK_WGT_N_USER_VALUE $values(URAM_N_USER) $values(ARCH_ICP) $values(ARCH_OCP)] $UBANK_WGT_N_USER
}
